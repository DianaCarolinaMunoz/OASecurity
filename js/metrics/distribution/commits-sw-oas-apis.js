        ...
        svg.selectAll(".bar1")
            ...
            .on("mouseover", function(event, d) {
                ...
                tooltip.style("opacity", 1)  // Cambiado a opacity 1
                    ...
                    .html(`
                        ${d.totalc_local_global_sum} Paths<br>
        ...
        svg.selectAll(".bar3")
            ...
            .on("mouseover", function(event, d) {
                ...
                tooltip.style("opacity", 1)  // Cambiado a opacity 1
                    .style("background", barColor)
                    .html(`
                        ${d.totalc_local_nolocal_global_sum} Paths<br>
        ...
        svg.selectAll(".bar4")
            ...
            .on("mouseover", function(event, d) {
                ...
                tooltip.style("opacity", 1)  // Cambiado a opacity 1
                    .style("background", barColor)
                    .html(`
                        ${d.totalc_nolocal_global_sum} Paths<br>
