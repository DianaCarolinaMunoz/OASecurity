...
d3.csv("data/tablecommits_methodswithglobalsecurity_5.csv").then(data => {
    ...
    //         const year = new Date(d.formattedTimeStamp).getFullYear();
    ...
    function drawConnectedScatterplot(aggregatedData) { 
        ...
        const svg = d3.select('#date-commits-classification-per')
            .append("svg")
        ...
        const x = d3.scaleTime()
            ...
            .range([MARGIN_COASP.LEFT, innerWidth_COASP + MARGIN_COASP.LEFT-80]);
